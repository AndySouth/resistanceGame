---
title: "Insecticide resistance management : prototype game scenarios v3 based on emergence"
author: "Andy South"
date: "`r Sys.Date()`"
...
In the following plots time is represented on the x axis, the top panel shows insecticide use, the middle panel shows vector population and the lower panel shows resistance (phenotypic). The code included e.g. `plot_sim(...)` is there merely to show us as developers how the scenarios were generated.
