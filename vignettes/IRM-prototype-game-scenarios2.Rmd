...
l_config2 <- config_control_plan(l_config, t_strt=1, t_stop=20, control_id='irs_pyr')
...
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
l_config2 <- config_control_plan(l_config, t_strt=1, t_stop=20, control_id='irs_ops')
plot_sim2( run_sim2(l_config=l_config2) )
```
...
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
l_config2 <- config_control_plan(l_config, t_strt=seq(1,20,2), t_stop=seq(1,20,2), control_id='irs_pyr')
plot_sim2( run_sim2(l_config=l_config2) )
```
...
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
l_config2 <- config_control_plan(l_config, t_strt=seq(1,20), t_stop=seq(1,20), control_id=c('irs_pyr','irs_ops'))
plot_sim2( run_sim2(l_config=l_config2) )
```
...
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
l_config2 <- config_control_plan(l_config, t_strt=1, t_stop=20, control_id='irs_pyr')
plot_sim2( run_sim2(resistance_modifier=0.1) )
```
