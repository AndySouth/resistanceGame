...
### scenario 8 : no insecticide use, maximum randomness (1) added
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
plot_sim( run_sim(use_pyr=NA, randomness=1) )
```

### scenario 9 : no insecticide use, randomness 0.2 added
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=6}
plot_sim( run_sim(use_pyr=NA, randomness=0.2) )
```
