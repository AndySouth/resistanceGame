...
plot_sim2( run_sim_emerge(l_config=l_config2) )
...
## ---- eval=TRUE, echo=TRUE, message=FALSE, results='hide', fig.width=7, fig.height=6----
plot_sim2( run_sim_emerge(randomness=0.5) )

## ---- eval=TRUE, echo=TRUE, message=FALSE, results='hide', fig.width=7, fig.height=6----
plot_sim2( run_sim_emerge(randomness=0.5) )

## ---- eval=TRUE, echo=TRUE, message=FALSE, results='hide', fig.width=7, fig.height=6----
plot_sim2( run_sim_emerge(randomness=0.1) )

## ---- eval=TRUE, echo=TRUE, message=FALSE, results='hide', fig.width=7, fig.height=6----
l_config2 <- config_plan(l_config, t_strt=1, t_stop=20, control_id='irs_pyr')
plot_sim2( run_sim_emerge(l_config=l_config2, resistance_modifier=0.1) )

## ---- eval=TRUE, echo=TRUE, message=FALSE, results='hide', fig.width=7, fig.height=6----
plot_sim2( run_sim_emerge(l_config=l_config2, resistance_modifier=10) )
...
plot_sim2( run_sim_emerge(carry_cap=carry_cap, rate_growth=0.7), plot_cc=TRUE )
